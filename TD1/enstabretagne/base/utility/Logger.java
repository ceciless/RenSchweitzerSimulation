...
import simulation.engine.ISimulationDateProvider;
...
public class Logger {
	...
	public static void setScenarioId(ScenarioId scenarioId) {
		log.scenarioId = scenarioId;
	}
    ...
    public static void Info(LogicalDateTime logicalDateTime, Object obj, String function, String message, Object...args)
    {
    	log.tri(logicalDateTime, LogLevels.information, obj, function, message, args);
    }
    ...
    private void log(LogLevels level, Object obj,String function,String message,Object... args) {
		SimEntity simEntity = (SimEntity) obj;
		log(scenarioId,Instant.now(),simEntity.currentDate(),level,obj,function, message,args);
    		
	}
    private void tri(LogicalDateTime logicalDateTime, LogLevels level, Object obj,String function,String message,Object... args) {
    	if(scenarioId!=null) {
    		if(scenarioId instanceof ScenarioId){
    			log(scenarioId,Instant.now(),logicalDateTime,level,obj,function, message,args);
